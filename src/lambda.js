export const handler = async(event) => {
    ...
    const recipes = [
        ...
        {name: "Potatoh stew", description: "Heat up an oven or a pot and add some oil. Add the chunks of meat to the pot and brown them on all sides.Make sure to stir in the pot once in a while, so the meat doesn't burn. Put some salt in the pot and add some warm water, about half cup, or to almost cover the meat. Cover the pot and allow it to simmer for about 30 minutes or until the meat is almost tender. While the meat is cooking, prepare the potatoes. These need to be cleaned, peeled and cut in about 1 inch cubes. Add them to the pot together with a cup of warm water and allow them to cook until they are tender. Add the tomato paste and more salt and pepper to taste. Stir gently, so the potatoes don't break. When ready, place it in the oven at 350F for 30 minutes. Sprinkle some fresh parsley or chopped dill on top and serve in bowls. Don't cook it too much, you need the stew to have some sauce. Serving it with bread is recommended.", ingredients: ["potatoh", "peppers", "beef", "paprika", "tomatoh_sauce"]},
